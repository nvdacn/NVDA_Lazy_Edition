...
2. 在本程序的“选择附加任务”页面，还提供了“在欢迎界面启用 NVDA”、“修复音频闪避等功能无法使用”、“语音合成器设置”、“导入 VVTTS 语音字典（仅用于 SAPI4）”、“修改 DragAndDrop 插件的台式机快捷键与笔记本键盘方案相同”、“清空用户配置文件夹”等附加选项，可按需选择使用。其中：“语音合成器设置”选项可设置 NVDA 首次运行时的默认语音引擎；“导入 VVTTS 语音字典（仅用于 SAPI4）”选项用以解决部分字符在SAPI4 接口的 VVTTS 发音错误或读乱码的问题；“修改 DragAndDrop 插件的台式机快捷键与笔记本键盘方案相同”选项仅对简体中文语言生效，用以解决台式机键盘方案下的部分热键冲突。
